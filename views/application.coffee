...
$(document).ready ->
  ...
  for i in [0..(js_members.length-1)]
    $("#radio#{i}_0_0").on 'click', ->
      ...
      $("#radio#{this.value}_0_0").attr("class", "btn btn-info btn-lg active")
      $("#radio#{this.value}_0_1").attr("class", "btn btn-lg")
    $("#radio#{i}_0_1").on 'click', ->
      $("#radio#{this.value}_0").val("1")
      $("#radio#{this.value}_0_0").attr("class", "btn btn-lg")
      $("#radio#{this.value}_0_1").attr("class", "btn btn-info btn-lg active")
    $("#radio#{i}_1_0").on 'click', ->
      $("#radio#{this.value}_1").val("0")
      $("#radio#{this.value}_1_0").attr("class", "btn btn-warning btn-lg active")
      $("#radio#{this.value}_1_1").attr("class", "btn btn-lg")
    $("#radio#{i}_1_1").on 'click', ->
      $("#radio#{this.value}_1").val("1")
      $("#radio#{this.value}_1_0").attr("class", "btn btn-lg")
      $("#radio#{this.value}_1_1").attr("class", "btn btn-warning btn-lg active")
    $("#radio#{i}_2_0").on 'click', ->
      $("#radio#{this.value}_2").val("0")
      $("#radio#{this.value}_2_0").attr("class", "btn btn-success btn-lg active")
      $("#radio#{this.value}_2_1").attr("class", "btn btn-lg")
      $("#radio#{this.value}_2_2").attr("class", "btn btn-lg")
      $("#radio#{this.value}_2_3").attr("class", "btn btn-lg")
    $("#radio#{i}_2_1").on 'click', ->
      $("#radio#{this.value}_2").val("1")
      $("#radio#{this.value}_2_0").attr("class", "btn btn-lg")
      $("#radio#{this.value}_2_1").attr("class", "btn btn-success btn-lg active")
      $("#radio#{this.value}_2_2").attr("class", "btn btn-lg")
      $("#radio#{this.value}_2_3").attr("class", "btn btn-lg")
    $("#radio#{i}_2_2").on 'click', ->
      ...
      $("#radio#{this.value}_2_0").attr("class", "btn btn-lg")
      $("#radio#{this.value}_2_1").attr("class", "btn btn-lg")
      $("#radio#{this.value}_2_2").attr("class", "btn btn-success btn-lg active")
      $("#radio#{this.value}_2_3").attr("class", "btn btn-lg")
    $("#radio#{i}_2_3").on 'click', ->
      ...
      $("#radio#{this.value}_2_1").attr("class", "btn btn-lg")
      $("#radio#{this.value}_2_2").attr("class", "btn btn-lg")
      $("#radio#{this.value}_2_3").attr("class", "btn btn-success btn-lg active")
