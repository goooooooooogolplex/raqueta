...
$(document).ready ->
  ...
  for i in [0..(js_members.length-1)]
    $("#radio#{i}_0_0").on 'click', ->
      ...
      $("#radio#{this.value}_0_1").attr("class", "btn ")
    $("#radio#{i}_0_1").on 'click', ->
      $("#radio#{this.value}_0").val("1")
      $("#radio#{this.value}_0_0").attr("class", "btn ")
    ...
    $("#radio#{i}_1_0").on 'click', ->
      ...
      $("#radio#{this.value}_1_1").attr("class", "btn ")
    $("#radio#{i}_1_1").on 'click', ->
      $("#radio#{this.value}_1").val("1")
      $("#radio#{this.value}_1_0").attr("class", "btn ")
    ...
    $("#radio#{i}_2_0").on 'click', ->
      ...
      $("#radio#{this.value}_2_1").attr("class", "btn ")
      $("#radio#{this.value}_2_2").attr("class", "btn ")
      $("#radio#{this.value}_2_3").attr("class", "btn ")
    $("#radio#{i}_2_1").on 'click', ->
      $("#radio#{this.value}_2").val("1")
      $("#radio#{this.value}_2_0").attr("class", "btn ")
